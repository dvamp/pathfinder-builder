...
class DragonRaceAge < ActiveRecord::Base
  ...
  def get_aura(dragon_race, dragon)
    ...
    aura_array.each {|elem|
      ...
      if elem.strip == "frightful presence"
        aura = aura + I18n.t("models.#{self.class.model_name.underscore}.aura.#{elem.strip}") + "(" + (self.age_id * 30).to_s + "ft., DC" + (10 + (dragon["hit_dice_count"] * 0.5).to_i + dragon["chr_modifer"]).to_s + ")"
      ...
      if elem.strip == "slow aura"
        aura = aura + I18n.t("models.#{self.class.model_name.underscore}.aura.#{elem.strip}")
        if self.age_id > 11
  ...
  def get_special_attack(dragon_race, dragon_age_category, size_category, dragon)
    ...
    spa_array.each {|elem|
      ...
      if elem.strip == "breath weapon"
        ...
        special_attack = special_attack + I18n.t("models.#{self.class.model_name.underscore}.special_attack.#{elem.strip}") + "(DC" + (10 + (dragon["hit_dice_count"] * 0.5).to_i + dragon["con_modifer"]).to_s + ")"
        ...
        special_attack = special_attack + I18n.t("models.#{self.class.model_name.underscore}.special_attack.#{elem.strip}") + "(3回/日 DC" + (10 + 6 + dragon["chr_modifer"]).to_s + ")"
      elsif elem.strip == "ice tomb"
        special_attack = special_attack + I18n.t("models.#{self.class.model_name.underscore}.special_attack.#{elem.strip}") + "(1回/日 DC" + (10 + 9 + dragon["chr_modifer"]).to_s + ")"
      elsif elem.strip == "mass laughter"
        special_attack = special_attack + I18n.t("models.#{self.class.model_name.underscore}.special_attack.#{elem.strip}") + "(DC" + (10 + 6 + dragon["chr_modifer"]).to_s + ")"
      elsif elem.strip == "deadly joke"
        special_attack = special_attack + I18n.t("models.#{self.class.model_name.underscore}.special_attack.#{elem.strip}") + "(DC" + (10 + 9 + dragon["chr_modifer"]).to_s + ")"
      end
    }
    # サイズ段階で獲得する特殊攻撃
    if size_category.crush_damage != ""
      ...
      special_attack = special_attack + ", " + I18n.t("models.#{self.class.model_name.underscore}.special_attack.crush") +"(" + temp_size_category.name_localizable + " DC" + (10 + (dragon["hit_dice_count"] * 0.5).to_i + dragon["con_modifer"]).to_s + " " + size_category.crush_damage + "+" + ((dragon["str_modifer"] * 1.5).to_i).to_s + ")"
    end
    if size_category.tail_sweep_damage != ""
      ...
      special_attack = special_attack + ", " + I18n.t("models.#{self.class.model_name.underscore}.special_attack.tail sweep") +"(" + temp_size_category.name_localizable + " DC" + (10 + (dragon["hit_dice_count"] * 0.5).to_i + dragon["con_modifer"]).to_s + " " + size_category.tail_sweep_damage + "+" + ((dragon["str_modifer"] * 1.5).to_i).to_s + ")"
    end
  ...
  def sense_localizable
    ...
    sense_array.each {|elem|
      ...
      sense = sense + I18n.t("models.#{self.class.model_name.underscore}.sense.#{elem.strip}")
    }
    return sense
  end
  ...
  def defensive_ability_localizable
    if self.defensive_ability != ""
      ...
      defensive_ability_array.each{|elem|
        ...
        defensive_ability = defensive_ability + I18n.t("models.#{self.class.model_name.underscore}.defensive_ability.#{elem.strip}")
      }
    ...
    if self.dr != ""
      ...
      dr_array.each_with_index{|elem, i|
        if i%2 == 0
          ...
          dr = dr + "/" + I18n.t("models.#{self.class.model_name.underscore}.dr.#{elem.strip}")
        end
      }
      return dr
    else
  ...
  def additional_move_localizable
    if self.additional_move != ""
      ...
      additional_move_array.each{|elem|
        ...
        additional_move = additional_move + I18n.t("models.#{self.class.model_name.underscore}.additional_move.#{elem.strip}")
      }
  ...
  def sp_localizable
    if self.sp != ""
      ...
      sp_array.each {|elem|
        sp = sp + ", " if sp != ""
        sp = sp + I18n.t("models.#{self.class.model_name.underscore}.sp.#{elem.strip}")
      }
      return sp
    else
      return self.sp
  ...
  def caster_source_localizable
    if self.caster_source != ""
      return I18n.t("models.#{self.class.model_name.underscore}.caster_source.#{self.caster_source}")
    else
  ...
  def sq_localizable
    if self.sq != ""
      ...
      sq_array.each {|elem|
        sq = sq + ", " if sq != ""
        sq = sq + I18n.t("models.#{self.class.model_name.underscore}.sq.#{elem.strip}")
      }
      return sq
    else
      return self.sq
